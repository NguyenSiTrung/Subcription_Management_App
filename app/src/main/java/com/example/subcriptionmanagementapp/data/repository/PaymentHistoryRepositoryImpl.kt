...
class PaymentHistoryRepositoryImpl(
    ...
    override fun getPaymentHistoryBySubscriptionId(subscriptionId: Long): Flow<List<PaymentHistory>> {
        return paymentHistoryDao.getPaymentHistoryBySubscriptionId(subscriptionId)
    }

    override suspend fun getPaymentHistoryByDateRange(startDate: Long, endDate: Long): List<PaymentHistory> {
