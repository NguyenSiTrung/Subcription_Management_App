...
import com.example.subcriptionmanagementapp.data.repository.*
...
class BackupManager @Inject constructor(
    ...
    suspend fun createBackup(): Uri? = withContext(Dispatchers.IO) {
        try {
            ...
            val paymentHistory = paymentHistoryRepository.getAllPaymentHistory()
    ...
    suspend fun restoreBackup(uri: Uri): Boolean = withContext(Dispatchers.IO) {
        try {
            ...
            paymentHistoryRepository.deleteAllPaymentHistory()
    ...
    private class DateTypeAdapter : com.google.gson.JsonSerializer<Date>, com.google.gson.JsonDeserializer<Date> {
