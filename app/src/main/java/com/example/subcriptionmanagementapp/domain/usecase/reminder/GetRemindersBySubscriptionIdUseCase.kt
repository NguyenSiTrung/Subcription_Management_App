...
class GetRemindersBySubscriptionIdUseCase
@Inject
constructor(private val reminderRepository: ReminderRepository) {
    operator fun invoke(subscriptionId: Long): Flow<List<Reminder>> {
        return reminderRepository.getRemindersBySubscriptionId(subscriptionId)
    }
}
